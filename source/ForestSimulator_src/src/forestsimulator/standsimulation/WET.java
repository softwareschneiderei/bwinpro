...
//        
         ...
         while (i.hasNext()) {
            ...
            if (land.equals("Niedersachsen") && wbr==0 && nrx==nr){
                ...
                try {  wttxt[11]=sortiment.getChild("Verjuengungsgang").getText().trim();
                  } catch (Exception e){ wttxt[11]=" "; }
                try {  wttxt[12]=sortiment.getChild("PflanzungsSchlussgrad").getText().trim();
                  } catch (Exception e){ wttxt[12]="0.0"; }
