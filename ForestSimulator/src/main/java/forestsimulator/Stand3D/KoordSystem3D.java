...
public class KoordSystem3D {
    ...
    private TransformGroup makeAxis(StandBase3D base) {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            Appearance a;
            if (dummy) {
                a = createMatAppear(new Color3f(1.0f, 0.0f, 0.0f), new Color3f(1.0f, 0.0f, 0.0f), 100.0f);
            } else {
                a = createMatAppear(new Color3f(1.0f, 1.0f, 1.0f), new Color3f(1.0f, 1.0f, 1.0f), 100.0f);
            }
