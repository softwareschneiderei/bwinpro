...
public class DynamicSiteIndexModelParameters {
    ...
    public DynamicSiteIndexModelParameters() {
        this(1d, 1d, 1d, 1d, 1d, 1d, 1d);
    }
    
    public DynamicSiteIndexModelParameters(double parameter1, double parameter2, double parameter3, double parameter4, double parameter5, double parameter6, double parameter7) {
        super();
