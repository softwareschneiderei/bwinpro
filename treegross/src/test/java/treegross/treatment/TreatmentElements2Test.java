...
public class TreatmentElements2Test {
    ...
    private static final ThinningDefinitions unusedThinningDefinitions = new ThinningDefinitions("", "", "");
    ...
    */
    ...
    private Iterable<Species> addSpeciesTo() {
        ...
        oak.spDef.dynamicThinning = new HeightBasedThinning(unusedThinningDefinitions, Arrays.asList(new ThinningFactorRange(20, 35, 0.8)));
        oak.d100 = 2d;
        oak.h100 = 30d;
        ...
        spruce.spDef.dynamicThinning = new HeightBasedThinning(unusedThinningDefinitions, Arrays.asList(new ThinningFactorRange(20, 37, 0.7)));
        spruce.d100 = 1.5d;
        spruce.h100 = 35d;
