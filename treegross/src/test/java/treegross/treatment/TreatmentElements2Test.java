...
public class TreatmentElements2Test {
    ...
    */
    ...
    private Iterable<Species> exampleSpecies() {
        ...
        oak.spDef.moderateThinning = new HeightBasedThinning("", new DefinedRanges(new ThinningValueRange(20, 35, 0.8)));
        oak.d100 = 2d;
        oak.h100 = 30d;
        ...
        spruce.spDef.moderateThinning = new HeightBasedThinning("", new DefinedRanges(new ThinningValueRange(20, 37, 0.7)));
        spruce.d100 = 1.5d;
        spruce.h100 = 35d;
